...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_new_category'] = 'New Category';//$this->language->get('text_new_category');
		...
		$data['new_category'] = $this->url->link('catalog/new_category', 'token=' . $this->session->data['token'], 'SSL');
