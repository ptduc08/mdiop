...
class ControllerExtensionNews extends Controller {
	...
	protected function form() {
		...
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		// hoangPH for new-category
		// Categories
		$this->load->model('catalog/newcategory');

		if (isset($this->request->post['new_category'])) {
			$categories = $this->request->post['new_category'];
		} elseif (isset($this->request->get['news_id'])) {
			$categories = $this->model_extension_news->getNewCategories($this->request->get['news_id']);
		} else {
			$categories = array();
		}
