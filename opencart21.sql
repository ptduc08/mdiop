...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2016 at 08:37 AM
...
(1, 'Default', '', 1, '2016-02-04 10:10:00', '2016-02-04 10:10:00');
...
(20, 'catalog/banner01_1407808530.png', 0, 1, 1, 1, 1, '2009-01-05 21:49:43', '2016-02-04 14:20:14'),
...
(25, 1, 'Components', '', '', '', ''),
(24, 1, 'Phones &amp; PDAs', '', '', '', ''),
(20, 1, 'Desktops', '&lt;p&gt;\r\n	Example of category description text&lt;/p&gt;\r\n', 'Example of TAG TITLE', 'Example of category description', ''),
(35, 1, 'test 1', '', '', '', ''),
(36, 1, 'test 2', '', '', '', ''),
(37, 1, 'test 5', '', '', '', ''),
(38, 1, 'test 4', '', '', '', ''),
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.68580002, 1, '2016-02-04 04:26:14'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2016-02-04 07:55:28'),
(3, 'Euro', 'EUR', '', '€', '2', 0.90200001, 1, '2016-02-04 04:26:14');
...
(1, '<!DOCTYPE HTML PUBLIC "-//IETF//DTD HTML 2.0//EN">\n<html><head>\n<title>301 Moved Permanently</title>\n</head><body>\n<h1>Moved Permanently</h1>\n<p>The document has moved <a href="https://www.marketinsg.com/index.php?route=information/news/system&amp;url=http%3A%2F%2Flocalhost%2Fopencart-2.1.0.1%2Fupload%2F">here</a>.</p>\n<hr>\n<address>Apache/2.4.12 (Unix) OpenSSL/1.0.1e-fips mod_bwlimited/1.4 Server at www.marketinsg.com Port 80</address>\n</body></html>\n', '2016-02-04 10:26:13');
...
(3, 1, 1, 'test', '&lt;p&gt;testss&lt;br&gt;&lt;/p&gt;', 'test');

-- --------------------------------------------------------

--
-- Table structure for table `oc_new_category`
--

CREATE TABLE `oc_new_category` (
  `category_id` int(11) NOT NULL,
  `image` varchar(255) DEFAULT NULL,
  `parent_id` int(11) NOT NULL DEFAULT '0',
  `top` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `oc_new_category`
--

INSERT INTO `oc_new_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
(64, '', 0, 0, 1, 0, 1, '2016-02-04 10:57:48', '2016-02-04 10:57:48'),
(65, '', 0, 0, 1, 0, 1, '2016-02-04 10:59:00', '2016-02-04 10:59:00');

-- --------------------------------------------------------

--
-- Table structure for table `oc_new_category_description`
--

CREATE TABLE `oc_new_category_description` (
  `category_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Dumping data for table `oc_new_category_description`
--

INSERT INTO `oc_new_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(64, 1, 'Company news', 'Company news', 'Company news', 'Company news', 'Company news'),
(65, 1, 'Market news', '&lt;p&gt;Market news&lt;br&gt;&lt;/p&gt;', 'Market news', 'Market news', 'Market news');

-- --------------------------------------------------------

--
-- Table structure for table `oc_new_category_filter`
--

CREATE TABLE `oc_new_category_filter` (
  `category_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `oc_new_category_path`
--

CREATE TABLE `oc_new_category_path` (
  `category_id` int(11) NOT NULL,
  `path_id` int(11) NOT NULL,
  `level` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `oc_new_category_path`
--

INSERT INTO `oc_new_category_path` (`category_id`, `path_id`, `level`) VALUES
(64, 64, 0),
(65, 65, 0);
...
--
-- Table structure for table `oc_new_category_to_layout`
--

CREATE TABLE `oc_new_category_to_layout` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `oc_new_category_to_layout`
--

INSERT INTO `oc_new_category_to_layout` (`category_id`, `store_id`, `layout_id`) VALUES
(64, 0, 0),
(65, 0, 0);
...
--
-- Table structure for table `oc_new_category_to_store`
--

CREATE TABLE `oc_new_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `oc_new_category_to_store`
--

INSERT INTO `oc_new_category_to_store` (`category_id`, `store_id`) VALUES
(64, 0),
(65, 0);
...
--
-- Table structure for table `oc_new_to_category`
--

CREATE TABLE `oc_new_to_category` (
  `new_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `oc_new_to_category`
--

INSERT INTO `oc_new_to_category` (`new_id`, `category_id`) VALUES
(1, 64),
(1, 65);
...
(42, 'Product 15', '', '', '', '', '', '', '', 990, 5, 'catalog/demo/apple_cinema_30.jpg', 8, 1, '100.0000', 400, 9, '2009-02-04', '12.50000000', 1, '1.00000000', '2.00000000', '3.00000000', 1, 1, 2, 0, 1, 26, '2009-02-03 21:07:37', '2011-09-30 00:46:19'),
...
(290, 0, 'config', 'config_email', 'phamhuyhoang1112@gmail.com', 0),
...
(292, 0, 'config', 'config_encryption', '', 0),
...
(291, 0, 'config', 'config_url', 'http://localhost/opencart-2.1.0.1/upload/', 0),
(294, 0, 'news', 'news_status', '1', 0);
...
(844, 'category_id=64', 'Company news'),
(845, 'category_id=65', 'Market news');
...
(1, 1, 'admin', 'e2ad280e42ec11beb07c4580718c72c28cdb3741', 'F51WZ1RXi', 'John', 'Doe', 'phamhuyhoang1112@gmail.com', '', '', '::1', 1, '2016-02-04 10:10:00');
...
--
-- Indexes for table `oc_new_category`
--
ALTER TABLE `oc_new_category`
  ADD PRIMARY KEY (`category_id`),
  ADD KEY `parent_id` (`parent_id`);

--
-- Indexes for table `oc_new_category_description`
--
ALTER TABLE `oc_new_category_description`
  ADD PRIMARY KEY (`category_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `oc_new_category_filter`
--
ALTER TABLE `oc_new_category_filter`
  ADD PRIMARY KEY (`category_id`,`filter_id`);

--
-- Indexes for table `oc_new_category_path`
--
ALTER TABLE `oc_new_category_path`
  ADD PRIMARY KEY (`category_id`,`path_id`);

--
-- Indexes for table `oc_new_category_to_layout`
--
ALTER TABLE `oc_new_category_to_layout`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `oc_new_category_to_store`
--
ALTER TABLE `oc_new_category_to_store`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `oc_new_to_category`
--
ALTER TABLE `oc_new_to_category`
  ADD PRIMARY KEY (`new_id`,`category_id`),
...
--
ALTER TABLE `oc_marketinsg_news_log`
  MODIFY `marketinsg_news_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT for table `oc_new_category`
--
ALTER TABLE `oc_new_category`
